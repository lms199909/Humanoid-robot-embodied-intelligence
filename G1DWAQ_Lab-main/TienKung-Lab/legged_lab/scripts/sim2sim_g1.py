...
将在 Isaac Lab 中训练的 G1 机器人 g1_flat 策略迁移到 MuJoCo 仿真环境中运行。
...
注意: g1_flat 没有 gait phase 信息，与 tienkung 不同

使用方法：
---------
python legged_lab/scripts/sim2sim_g1_flat.py --policy <policy.pt> --model <g1.xml>
...
def main():
    ...
    # 默认路径
    default_policy = os.path.join(LEGGED_LAB_ROOT, "logs/g1_flat/2025-12-30_17-30-34/exported/policy.pt")
